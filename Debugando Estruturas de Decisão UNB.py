'''Nesse desafio, chamado 'Debugando Estruturas de Decisão', devemos avaliar os requisitos
do programa e corrigir um código mal escrito para entregar os
índices de diversos tipos a uma empresa'''
