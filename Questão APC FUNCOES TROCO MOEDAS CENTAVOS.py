'''O caixa de um supermercado precisa dar o troco de x centavos.  Sabendo que as moedas disponíveis no caixa são de R$ 0,50, 
R$ 0,25, RS 0,10, R$ 0,05 e R$ 0,001, elabore uma função chamada troco que receba o valor inteiros x, do troco em centavos,
como parâmetro e imprima a quantidade de moedas de 50, 25, 10, 5 e 1 centavos que deve dar, de forma a minimizar a 
 quantidade de moedas do troco.'''
def troco(T):
